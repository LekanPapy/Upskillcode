...
namespace ProgrammingLesson
{
    class Program
    {
        ...
        {
            //Must learn C-sharp keywords are
            //Class (instance, static)
            //Class Constructor, Object
            //Method / Function (void, type (return), argument/parameter)
            //Datatypes (string (covered), integer (covered), boolean , var, double (covered) etc)
            ...
            //Comparison operators (== (covered), <=, >=, !=, &&, || etc)
            //Control statements (Selection and Iteration)
            //Selection statements (if (covered), switch-case)
            //Iteration statements (for, while, foreach)
            //Collections (List, Dictionary, Array, ArrayList)
            ...
            //Debugging
            //Try-catch (error or exception handling)
            //Code refactoring
